...
RSpec.describe 'Users', type: :request do
  describe 'GET /index' do
    it 'response status should be correct' do
      get users_url # users_url is route helper method for generating url for index action of users controller
  ...
  describe 'GET/show' do
    before(:all) do
      @user = User.create(name: 'John Doe', photo: 'https://example.com/user.jpg', bio: 'Lorem ipsum dolor sit amet.',
                          posts_counter: 0)
    end
    it 'renders successful response' do
      get user_url(@user) # user_url is route helper method for generating url for show action of users controller
