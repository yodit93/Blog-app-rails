...
Clone this [repository](https://github.com/yodit93/Blog-app-rails.git) to your desired folder.
...
- Clone this [repository](https://github.com/yodit93/Blog-app-rails.git) in your local machine with correct branch.
- Run following cmds:-
- **rails db:create**
- **rails db:migrate**
- **rails s**
